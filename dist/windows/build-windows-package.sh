...
# Change to project root (two levels up from dist/windows/)
...
BATCH_FILE="$SCRIPT_DIR/run_web2book.bat"
if [ ! -f "$BATCH_FILE" ]; then
    echo "ERROR: run_web2book.bat not found at $BATCH_FILE"
    exit 1
fi
cp "$BATCH_FILE" "$DIST_DIR/"
